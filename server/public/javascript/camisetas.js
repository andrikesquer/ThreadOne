  ...
  fetch("/json/productos.json")
    ...
    .then((data) => {
      ...
      filteredCamisetas.forEach((camiseta) => {
        ...
        camisetaElement.className = "swiper-slide";
        camisetaElement.innerHTML = `
          ...
          <div class="product-content" id="productContent">
              <div class="product-txt">
                  <span id="precio">$${camiseta.precio}</span>
                  <h3 id="producto">${camiseta.producto}</h3>
                  <p>Disponible</p>
              </div>
              <div class="product-img">
                  <img src="${camiseta.imagen}" alt="${camiseta.nombre}" id="imagen">
              </div>
          </div>
          <a href="/camisetas/${camiseta.producto}?precio=${camiseta.precio}&imagen=${camiseta.imagen}&color=${camiseta.color}">
              <button id="detalles">Ver más</button>
          </a>
        `;
        container.appendChild(camisetaElement);
      });
